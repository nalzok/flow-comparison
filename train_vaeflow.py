...
if __name__ == '__main__':
    ...
    parser.add_argument("--beta", dest='beta', default=400,
    ...
    optimizer2 = torch.optim.Adam(trainable_parameters, lr=args.lr, betas=(0.8, 0.9),
    ...
    for epoch in range(args.num_epochs):
        ...
        if epoch % 50 ==0:
            torch.save(modVAE.state_dict(), os.path.join(args.savedir, 'VAEModel_epo{}'.format(epoch)))
